            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/simpan-data-pelatihan" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="glukosa_darah_sewaktu" class="form-label">Glukosa Darah Sewaktu</label>
                            <input type="number" class="form-control" id="glukosa_darah_sewaktu"
                                name="glukosa_darah_sewaktu" required>
                        </div>
                        <div class="mb-3">
                            <label for="glukosa_darah_puasa" class="form-label">Glukosa Darah Puasa</label>
                            <input type="number" class="form-control" id="glukosa_darah_puasa"
                                name="glukosa_darah_puasa" required>
                        </div>
                        <div class="mb-3">
                            <label for="glukosa_dua_jam" class="form-label">Glukosa Darah Dua Jam</label>
                            <input type="number" class="form-control" id="glukosa_dua_jam" name="glukosa_dua_jam"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="hba1c" class="form-label">HBA1C</label>
                            <input type="number" class="form-control" id="hba1c" name="hba1c" required>
                        </div>
                        <div class="mb-3">
            ...
            <table class="table align-items-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Glukosa Darah Sewaktu</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Glukosa Darah Puasa</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Glukosa Dua Jam</th>
                        ...
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Kecepatan Gejala</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Riwayat Keluarga</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Berat Badan</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Jenis Kelamin</th>
                        <th class="text-uppercase text-xs font-weight-bolder opacity-7">Tipe Diabetes</th>
                ...
                <tbody>
                    @foreach ($trainings->items() as $index => $training)
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    id="name" value="{{ $training->name }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="glukosa_darah_sewaktu">Glukosa Darah Sewaktu</label>
                                                <input type="number" name="glukosa_darah_sewaktu"
                                                    class="form-control" id="glukosa_darah_sewaktu"
                                                    value="{{ $training->glukosa_darah_sewaktu }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="glukosa_darah_puasa">Glukosa Darah Puasa</label>
                                                <input type="number" name="glukosa_darah_puasa" class="form-control"
                                                    id="glukosa_darah_puasa"
                                                    value="{{ $training->glukosa_darah_puasa }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="glukosa_dua_jam">Glukosa Dua Jam</label>
                                                <input type="number" name="glukosa_dua_jam" class="form-control"
                                                    id="glukosa_dua_jam" value="{{ $training->glukosa_dua_jam }}"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                <label for="hba1c">HBA1C</label>
                                                <input type="number" name="hba1c" class="form-control"
                                                    id="hba1c" value="{{ $training->hba1c }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="usia">Usia</label>
                                                <input type="number" name="usia" class="form-control"
                                                    id="usia" value="{{ $training->usia }}" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="berat_badan" class="form-control"
                                                    id="berat_badan" value="{{ $training->berat_badan }}" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="tipe_diabetes" id="tipe_diabetes" class="form-control">
                                                    <option value="0"
                        ...
                        <tr>
                            ...
                            <td class="text-xs font-weight-bold">{{ $training->name }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->glukosa_darah_sewaktu }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->glukosa_darah_puasa }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->glukosa_dua_jam }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->hba1c }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->usia }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->kecepatan_gejala }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->riwayat_keluarga }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->berat_badan }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->jenis_kelamin }}</td>
                            <td class="text-xs font-weight-bold">{{ $training->tipe_diabetes }}</td>
                            <td class="text-xs font-weight-bold">
                                <a href="#" class="btn btn-success btn-sm mt-2" data-bs-toggle="modal"
                                    data-bs-target="#editModal-{{ $training->id }}">
                                    Edit
                                </a>

                                <a href="{{ route('trainings.destroy', $training->id) }}"
                                    class="btn btn-danger btn-sm mt-2" data-confirm-delete="true">Hapus</a>
